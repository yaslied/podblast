    ...
    <div class="perfil-template">
      ...
      <nav class="nav-withList">
        ...
        <div class="identity">
          ...
          <span class="brand">Pob<strong>blast</strong></span>
        </div>
      ...
      <section id="section1" class="section img-background">
        ...
        <div class="user-container column">
          ...
          <div class="content column">
            ...
            <?= $this->Html->image('profile.png', ['class' => 'user-picture']) ?>
              ...
              <div class="right-col column">
                <span class="title">Alice Morais Ribeiro</span>
          ...
          <div class="content-edit column">
            <span class="email body">Alice.mr@email.com</span>
            ...
            <div class="description">
              ...
              <div class="border">
                <p>
                  sou usuária do podblast a um ano, adoro este app.description
                  muito completo e fácil de usar.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="section2">
        <span class="title">Meus Canais</span>
        ...
        <div class="channels row">
          <div class="channel-item">
            ...
            <div class="content">
            <?= $this->Html->image('placeholder.png') ?>

              <div class="description">
                <p>uma descricao sobre esse canal</p>
              </div>
            </div>
