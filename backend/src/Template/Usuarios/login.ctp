      ...
      <section id="section1" class="section img-background">
        ...
        <?= $this->Form->create() ?>
          <div class="content">
            ...
            <span class="subtitle">acesse sua conta</span>
            ...
            <?= $this->Form->button('Entrar', ['class' => 'primary-action btn-login dark-bt', 'id' => 'btn1']) ?>
            <?= $this->Form->end() ?>

            <span class="rg-txt">Ainda não é cadastrado?</span>
            <?= $this->Html->link('<strong>Crie sua conta</strong>', 
